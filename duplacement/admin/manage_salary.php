...
// select records
$sql = "select * from dup_salary";
$res = mysql_query($sql);

if ($_GET['act'] == "delete") {
	$delid = $_GET['delid'];
	$delres = mysql_query("delete from dup_salary where salaryid = '$delid'");
...
?>
    ...
    <td width="150" height="20" align="left" valign="middle"><span class="blue"><strong> MANAGE SALARY </strong></span></td>
	...
	?>
      ...
      <td width="150" height="30" align="left" valign="middle"><?php echo $rs['salaryname']?></td>
    <td width="60" height="30" align="left" valign="middle"><?php echo $rs['salarystatus']?></td>
    <td width="35" height="30" align="center" valign="middle"><a href="add_salary.php?id=<?php echo $salaryid; ?>&act=edit"><img src="../images/admin-edit.jpg" alt="edit" width="15" height="14" border="0" /></a></td>
    <td width="10" height="30" align="center" valign="middle">|</td>
    <td width="35" height="30" align="center" valign="middle"><a href="manage_salary.php?delid=<?php echo $salaryid; ?>&act=delete"><img src="../images/admin-del.jpg" alt="delete" width="15" height="16"  border=0/></a></td>
  	</tr>
	<?php } ?>
	</table>
	  </div>
