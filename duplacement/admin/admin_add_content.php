<?php include("header.php");?>
    ...
    <div style="width:600px; height:55px;">
      ...
      <div style="width:65px; height:55px; float:left;"><img src="../images/admin-add.jpg" alt="admin" /></div>
   	
      <div style="width:200px; height:55px; float:left;"><br /><span class="blue"><strong>ADD CONTENT</strong></span><br />Create or manage, admin<br />and </div>
