...
if ($_GET['act'] == "delete") {
	$delid = $_GET['delid'];
	$delres = mysql_query("delete from dup_coursetypes where id = '$delid'");
	triggerMessage("admin_course", "Account deleted successfully!");	
	//header("location:manage_course.php");
}

// select records
$sql = "select * from dup_coursetypes where pid !=0";
$res = mysql_query($sql);
...
?>
    ...
    <td  colspan="5" align="left" valign="middle"><?php outputTrigger('admin_course');?></td>    
  	</tr>
	<tr>
    ...
    <td width="35" height="30" align="center" valign="middle"><a href="add_course.php?id=<?php echo $id; ?>&act=edit"><img src="../images/admin-edit.jpg" alt="edit" width="15" height="14" border="0" /></a></td>
    <td width="10" height="30" align="center" valign="middle">|</td>
    <td width="35" height="30" align="center" valign="middle"><a href="manage_course.php?delid=<?php echo $id; ?>&act=delete"><img src="../images/admin-del.jpg" alt="delete" width="15" height="16"  border=0/></a></td>
  	</tr>
	<?php } ?>
	</table>
	  </div>
