							  ...
							  <tr>
								...
								<script src="../js/functions.js"></script>
								  <form id="form1" name="form1" method="get" action="" >									    											<table width="100%" border="0" cellspacing="1" cellpadding="5">
										  ...
										  <tr>
										    <td colspan="3" align="left" style="background-color:#DADADA"><table width="70%" border="0" align="center" >
                                              <tr>
                                                <td>Sort by</td>
										  ...
										  <tr>
								            ...
								            <td width="60%" align="left" class="orange">Description</td>
											 <td class="orange" align="center">Action</td>
									  	</tr>
										<?php $i=0;
										...
										<?php $i++;}?>
										  <?php if ($count == 0) {?>
										  <tr>
										    <td colspan="3" class="blue" align="center">No Records</td>
						              	  </tr>
									  	<?php }?>
										</table>												
								  </form>
