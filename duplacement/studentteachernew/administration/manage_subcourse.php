...
$sql = "SELECT courseid, coursename, parentid FROM student_course WHERE parentid = '$parentid' AND parentid!=0";
$res = mysql_query($sql);
}

function countSubCourse($course_id)
{
	$sql = "SELECT courseid, coursename, parentid FROM student_course WHERE courseid= '$course_id' AND parentid!=0";
								  ...
								  <form id="form1" name="form1" method="post" action="" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="MS11_grey"><a href="subcourse.php" class="left-heading">Add New Subcourse</a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td><table width="100%" border="0">
                                              ...
                                              <tr bgcolor="<?php echo $bgcolor;?>" class="MS12_blk">
                                                <td class="left-none"><?php echo $row['coursename'];?><a href="#?parentid=<?php echo $row['courseid'];?>"></a></td>
                                                <td align="center"><a href="subcourse.php?action=edit&amp;editid=<?php echo $row['courseid']?>" class="blue1" >EDIT </a><span class="blue">|</span> <a href="manage_course.php?delid=<?php echo $row['courseid'];?>&amp;action=delete"  class="blue1" onclick="return confirm('Are you sure to delete this Category?')">DELETE</a></td>
                                              </tr>
                                              <?php
												}
											  ?>
