...
{
	$delid = $_GET["delid"];
 	mysql_query("DELETE FROM `student_city` WHERE id='$delid'");
}

$sql = "SELECT id, city_name FROM student_city";
$res = mysql_query($sql);
							...
							<table border="0" width="100%" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="100%" valign="top" height="250">
								  <form id="form1" name="form1" method="post" action="" onSubmit="return cityform();" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr>
                                          <td class="orange" height="16">Manage City </td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey"><a href="#" class="left-heading" onclick="window.open('add_city.php','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">Add New City </a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td><table width="100%" border="0">
                                              ...
                                              <tr bgcolor="<?php echo $bgcolor;?>" class="MS12_blk">
                                                <td class="left-none"><?php echo $row['city_name'];?></td>
                                                <td align="center"><a href="#" class="blue1" onclick="window.open('add_city.php?action=edit&amp;editid=<?php echo $row['id']?>','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">EDIT </a><span class="blue">|</span> <a href="manage_city.php?delid=<?php echo $row['id']?>&amp;action=delete"  class="blue1" onclick="return confirm('Are you sure to delete this City?')">DELETE</a></td>
                                              </tr>
                                              <?php
												}
											  ?>
