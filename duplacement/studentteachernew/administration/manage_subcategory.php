...
if (!empty($_GET['parent_node'])) {
$parent_node	= $_GET['parent_node'];
$sql = "SELECT * FROM student_category WHERE parent_node = '$parent_node' AND parent_node!=0";
$res = mysql_query($sql);
}

function countadd_subcategories($course_id)
{
	$sql = "SELECT * FROM student_category WHERE id= '$course_id' AND parent_node!=0";
								  ...
								  <form id="form1" name="form1" method="post" action="" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="MS11_grey"><a href="add_subcategories.php" class="left-heading">Add New Sub Category</a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td><table width="100%" border="0">
                                              ...
                                              <tr bgcolor="<?php echo $bgcolor;?>" class="MS12_blk">
                                                <td class="left-none"><?php echo $row['categoryname'];?><a href="#?parent_node=<?php echo $row['id'];?>"></a></td>
                                                <td align="center"><a href="add_subcategories.php?action=edit&amp;editid=<?php echo $row['id']?>" class="blue1" >EDIT </a><span class="blue">|</span> <a href="manage_categories.php?delid=<?php echo $row['id'];?>&amp;action=delete"  class="blue1" onclick="return confirm('Are you sure to delete this Category?')">DELETE</a></td>
                                              </tr>
                                              <?php
												}
											  ?>
