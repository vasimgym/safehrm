<?php include("header.php");?>
    ...
    <div style="background-image:url(images/nav-grads-bar.jpg); background-repeat:repeat-x; padding-left:15px; padding-bottom:5px; padding-right:10px; 
      padding-top:6px; width:575px; float:left; line-height:18px;">

		<table width="580" border="0" cellspacing="0" cellpadding="0">
	  	<tr>
	    <td width="30" align="left" valign="middle"><strong><img src="../images/admin-star.jpg" alt="star" /></strong></td>
	    <td width="150" height="20" align="left" valign="middle"><span class="blue"><strong> 		<span class="name">Dheeraj Kumar</span></strong></span></td>
	    <td width="350" height="20" align="left" valign="middle"></td>
	    <td width="50" height="20" align="center" valign="middle"><a href="admin_students.php" class="link">..back</a></td>
	  	</tr>
        </table><br /><br />
