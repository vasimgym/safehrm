...
// select records
$sql = "select * from dup_admin where user_class='user'";
$res = mysql_query($sql);
...
?>
    ...
    <td width="150" height="20" align="left" valign="middle"><span class="blue"><strong> MANAGE USER</strong></span></td>
    ...
    <td width="35" height="30" align="center" valign="middle"><a href="admin_manage_user.php?delid=<?php echo $user_id; ?>&act=delete"><img src="../images/admin-del.jpg" alt="delete" width="15" height="16"  border=0/></a></td>
  	</tr>
	<?php } ?>
