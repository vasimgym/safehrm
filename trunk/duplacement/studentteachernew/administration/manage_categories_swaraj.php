...
$sql = "SELECT id, categoryname FROM student_category";
$res = mysql_query($sql);
								  ...
								  <form id="form1" name="form1" method="post" action="" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="MS11_grey"><a href="#" class="left-heading" onclick="window.open('add_categories.php','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">Add New Categories</a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
