...
{
	$delid = $_GET["delid"];
 	mysql_query("DELETE FROM `student_status` WHERE id='$delid'");
}

$sql = "SELECT id, status_name, status_color FROM student_status";
$res = mysql_query($sql);
								...
								<td width="100%" valign="top" height="250">
								  <form id="form1" name="form1" method="post" action="" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr>
                                          <td class="orange" height="16">Manage Status </td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey"><a href="#" class="left-heading" onclick="window.open('add_status.php','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">Add New Status </a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td><table width="100%" border="0">
                                              ...
                                              <tr bgcolor="<?php echo $bgcolor;?>" class="MS12_blk">
                                                <td class="left-none"><?php echo $row['status_name'];?></td>
                                                <td class="left-none"><?php echo $row['status_color'];?></td>
                                                <td align="center"><a href="#" class="blue1" onclick="window.open('add_status.php?action=edit&amp;editid=<?php echo $row['id']?>','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">EDIT </a><span class="blue">|</span> <a href="manage_status.php?delid=<?php echo $row['id']?>&amp;action=delete"  class="blue1" onclick="return confirm('Are you sure to delete this Status?')">DELETE</a></td>
                                              </tr>
                                              <?php
												}
											  ?>
