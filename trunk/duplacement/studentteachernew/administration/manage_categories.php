...
{
	$delid = $_GET["delid"];
 	mysql_query("DELETE FROM student_category WHERE id='$delid'");
}
...
{
	$sql = "SELECT * FROM student_category WHERE parent_node= '$course_id' AND parent_node!=0";
							...
							<table border="0" width="100%" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="100%" valign="top" height="250">
								  <form id="form1" name="form1" method="post" action="manage_categories.php" >
								    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr>
                                          <td class="orange" height="16">Manage Course Categories </td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey"><a href="#" class="left-heading" onclick="window.open('add_categories.php','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">Add New Course Category</a></td>
                                        </tr>
                                        <tr>
                                          <td class="MS11_grey">&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td><table width="100%" border="0">
                                              ...
                                              <tr bgcolor="<?php echo $bgcolor;?>" class="MS12_blk">
                                                <td class="left-none"><?php echo $row['categoryname'];?></td>
                                                <td class="left-none"><a href="manage_subcategory.php?parent_node=<?php echo $row['id'];?>">
												<?php echo countSubCourse($row['id']);?></a></td>
                                                <td align="center"><a href="#" class="blue1" onclick="window.open('add_categories.php?action=edit&amp;editid=<?php echo $row['id']?>','newWin','width=500,height=200,menubar=no,location=no,resizable=yes,scrollbars=yes');">EDIT </a><span class="blue">|</span> <a href="manage_categories.php?delid=<?php echo $row['id'];?>&amp;action=delete"  class="blue1" onclick="return confirm('Are you sure to delete this Category?')">DELETE</a></td>
                                              </tr>
                                              <?php
												}
											  ?>
