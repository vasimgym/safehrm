<?php
	...
	if($button=="Save"){
		$subject_name = trim(stripslashes($_POST["subject_name"]));
		$ok = mysql_query("INSERT INTO `student_subject`(subject_name) VALUES('$subject_name')");	
		if($ok) $flag=1;
	}
	...
	if($button=="Edit"){
		$editid = $_POST["editid"];
		$subject_name = trim(stripslashes($_POST["subject_name"]));
		$ok = mysql_query("UPDATE `student_subject` SET subject_name='$subject_name'  WHERE id='$editid' ");
...
<p><?php echo $error;?></p>
<form action="add_subject.php" method="post" name="form1" onSubmit="return subjectform();">
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <td>
	...
	<tr>
       ...
       <td><input class="input-field" name="subject_name" value="<?php echo $row['subject_name'];?>" type="text" size="35"></td>
	</tr>
